package br.com.certiface.certifacesdk.demo.components
    ...
    Row(
        ...
        features.forEach { features ->
            ...
            OutlinedButton(
                ...
                border = BorderStroke(
                    1.dp,
                    if (isSel) CertifaceBlue else MaterialTheme.colorScheme.outline.copy(alpha = 0.5f)
                ),
                colors = ButtonDefaults.outlinedButtonColors(
                    containerColor = if (isSel) CertifaceBlue else Color.Transparent,
                    contentColor = if (isSel) CertifaceWhite else MaterialTheme.colorScheme.onSurface
                ),
